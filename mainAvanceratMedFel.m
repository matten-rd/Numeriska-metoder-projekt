...
%{
    Det avancerade programmet av det här projektet fast med fel i indata:
...
% f_0
[w, wt, Ehopp_0, Etid_0] = medFelAvancerat(L, hGren, g, m, k, kappa, phiToUse);

% alla fel (funk=hopplängd , t=flygtid, Ehopp=trunkfel för längd, Etid=trunkfel för tid)
[L_funk, Lt, Ehopp_L, Etid_L] = medFelAvancerat(L+E_L, hGren, g, m, k, kappa, phiToUse);
[hGren_funk, ht, Ehopp_h, Etid_h] = medFelAvancerat(L, hGren+E_hGren, g, m, k, kappa, phiToUse);
[g_funk, gt, Ehopp_g, Etid_g] = medFelAvancerat(L, hGren, g+E_g, m, k, kappa, phiToUse);
[m_funk, mt, Ehopp_m, Etid_m] = medFelAvancerat(L, hGren, g, m+E_m, k, kappa, phiToUse);
[k_funk, kt, Ehopp_k, Etid_k] = medFelAvancerat(L, hGren, g, m, k+E_k, kappa, phiToUse);
[kappa_funk, kappat, Ehopp_kappa, Etid_kappa] = medFelAvancerat(L, hGren, g, m, k, kappa+E_kappa, phiToUse);
[phi_funk, phit, Ehopp_phi, Etid_phi] = medFelAvancerat(L, hGren, g, m, k, kappa, phiToUse+E_phi);
